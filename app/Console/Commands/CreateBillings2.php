...
class CreateBillings2 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'billing:create2';  // Define the command name for calling in the terminal
    ...
    public function handle()
    {
        ...
        foreach ($users as $user) {
            ...
            foreach ($stores as $store) {
                ...
                $startDate = Carbon::now()->subDays(3); // Subtract 4 days from the current date
